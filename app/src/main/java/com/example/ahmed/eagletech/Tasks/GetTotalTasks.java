...
public class GetTotalTasks extends AsyncTask<String, Void, ArrayList> {

    private final String LOG_TAG = UserDataTask.class.getSimpleName();
    private Context mContext;
    public GetTotalTasks(Context context){
        mContext = context;
    }
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        try {
            ...
            final String BASE_URL =mContext.getString(R.string.server)+"tasks/get-tasks?";
