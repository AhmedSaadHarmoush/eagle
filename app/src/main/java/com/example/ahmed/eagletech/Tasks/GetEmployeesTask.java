...
public class GetEmployeesTask extends AsyncTask<String, Void, ArrayList> {

    private final String LOG_TAG = UserDataTask.class.getSimpleName();
    private Context mContext;
    public GetEmployeesTask(Context context){
        mContext = context;
    }
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        try {
            ...
            final String BASE_URL =mContext.getString(R.string.server)+"users/my-employees?";
